...
src_prepare() {
	...
	eapply "${FILESDIR}/0001-sanitizer_fixup-for-interception_type_test.patch"
	eapply "${FILESDIR}/0009-musl-patches.patch"
	#eapply "${FILESDIR}/0002-sanitizer-ASAN-fix-startup-crash-in-dlsym-for-long-paths-since.patch"
	#eapply "${FILESDIR}/0003-sanitizer-Minor-refactor-of-ThreadDescriptorSize.patch"
	#eapply "${FILESDIR}/0004-sanitizer-Use-const-char-in-internal_simple_strtoll.patch"
	#eapply "${FILESDIR}/0005-sanitizer-Use-confstr-to-check-libc-version-in-InitT.patch"
	#eapply "${FILESDIR}/0006-sanitizer-Fix-tsan-GO-build.patch"
	#eapply "${FILESDIR}/0007-sanitizer_common-Fix-using-libtirpc-on-Linux.patch"
	#eapply "${FILESDIR}/0008-sanitizer-test-Support-using-libtirpc-on-Linux.patch"
